 ...
 * @author MaisaDuarte
 */
public class Thread_ClueWeb_to_AllPairsData_To_Category extends Thread {

    List<ObjectENContextOccurrence> ListAllPairsData = new ArrayList();

    public Thread_ClueWeb_to_AllPairsData_To_Category(List<ObjectENContextOccurrence> ListAllPairsData) {
